    ...
    <div className="bg-black w-full h-full relative overflow-hidden">
      <div className="h-full w-full blur-1 relative">
        ...
        <div
          ...
          style={{
            background:
              "conic-gradient(from 175deg at 67.53% 36.82%, #7F7F7F 0deg, #999999 130deg, #C0C0C0 360deg)",
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle, #757575 0%, #BFBFBF 70%)",
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 66.87% 66.87% at 67.53% 36.82%, #828282 0%, #AFAFAF 36%, #E0E0E0 100%)",
