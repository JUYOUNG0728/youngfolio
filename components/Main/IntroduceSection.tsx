...
export default function IntroduceSection({ scrollRef }: IntroduceSectionProps) {
  ...
  return (
    ...
    >
      <div className="w-full h-screen overflow-hidden flex flex-col items-center pt-14 pb-32 justify-between gap-11 sticky top-0 lg:pt-20 lg:top-10 xl:top-24 xl:pb-48">
        ...
        <div className="flex flex-col items-center gap-11 lg:gap-20">
