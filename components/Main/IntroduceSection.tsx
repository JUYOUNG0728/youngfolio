...
export default function IntroduceSection({ scrollRef }: IntroduceSectionProps) {
  ...
  return (
    ...
    >
      <div className="w-full h-screen overflow-hidden flex flex-col items-center pt-20 pb-28 justify-between sticky top-14 xl:top-24">
        <p className="px-12 fullBody font-semibold text-outline-white text-justify">
          BLENDING TECHNOLOGY AND EMOTION, CREATING EXPERIENCES THAT GO BEYOND
          WORDS AND RESONATE WITH THE HEART.
        </p>
        <div className="flex flex-col items-center gap-20">
          <p className="body2 text-white text-center px-[44px] text-wrap">
